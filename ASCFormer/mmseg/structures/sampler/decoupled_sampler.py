...
class DecoupledSampler(BasePixelSampler):
    """Decoupled Sampler for contrastive learning in segmentation.
    """

    def __init__(self, context, thresh=None, max_points=1024, min_kept=100000):
        super().__init__()
